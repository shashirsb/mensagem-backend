...
public class MensagemIdStateMigration extends BaseVersionableJacksonJsonMigration {
    @Override
    public int currentVersion() {
        return MensagemStateId.currentSchemaVersion;
    }
    ...
    public JsonNode transform(int fromVersion, JsonNode json) {
        ...
        try {
            ...
            throw new SchemaMigrationException("A migração do MensagemState falhou", e);
        }
