...
public class MensagemPartialAttributesStateMigration extends BaseVersionableJacksonJsonMigration {
    @Override
    public int currentVersion() {
        return MensagemAtributosParciais.currentSchemaVersion;
    }
    ...
    public JsonNode transform(int fromVersion, JsonNode json) {
        ...
        try {
            ...
            throw new SchemaMigrationException("A migração do MensagemPartialAttributesStateMigration falhou", e);
        }
