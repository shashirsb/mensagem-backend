...
public abstract class BaseOracleReadSide<T> implements pt.min.saude.spms.hos.common.classes.backend.Upgradable {
  ...
  protected pt.min.saude.spms.hos.common.classes.backend.LogBuilder log ;
  
   protected com.lightbend.lagom.javadsl.persistence.jpa.JpaSession jpaSession ;
   protected java.lang.String oracleDatabase ;
   
   protected java.lang.String tableName ;
   
   protected com.fasterxml.jackson.databind.ObjectMapper objectMapper ;
   
   protected java.lang.Class<T> stateClass ;
